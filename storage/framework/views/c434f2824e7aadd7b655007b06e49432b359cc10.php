...
<div class="modal-dialog modal-dialog-scrollable" role="document">
    ...
    <div class="modal-body">
        <form method="post" action="<?php echo e(route('tambah_surat')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\xampp\htdocs\web-surat\resources\views/desa/surat/tambah.blade.php ENDPATH**/ ?>