    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <!-- <div class="auth-logo">
                        <a href="index.html"><img src="<?php echo e(asset('template/dist/assets/images/logo/logo.png')); ?>" alt="Logo"></a>
                    </div> -->
                    ...
                    <!-- <form action="<?php echo e(route('ceklogin')); ?>" method="post"> -->
                        ...
                        <div class="text-center mt-5 text-lg fs-4">
                            <p class='text-gray-600'>Tidak ada Akun? <a href="<?php echo e(route('register',$dt->title_user)); ?>"
                                class="font-bold">Daftar</a>.</p>
                               <!--  <p class='text-gray-600'><a href="<?php echo e(route('forgot',$dt->title_user)); ?>"
                    ...
                    success: function(response) {
                        ...
                        if (response.admin_desa) {
                            Swal.fire({
                                ...
                                window.location="<?php echo e(url('dashboard')); ?>"+"/"+response.admin_desa;
                            })
                        }
                        if (response.masuk_pengaju) {
                            ...
                            Swal.fire({
                                ...
                                window.location="<?php echo e(route('dashboard_pengaju')); ?>";
                            })
                        }
                        if (response.masuk_staff) {
                            Swal.fire({
                                ...
                                window.location="<?php echo e(route('dashboard_staff')); ?>";
                            })
                        }
                        if (response.masuk_kpldesa) {
                            Swal.fire({
                                ...
                                window.location="<?php echo e(route('dashboard_kepaladesa')); ?>";
                            })
                        }
