<?php $__env->startSection('title', 'Update Surat Permohonan'); ?>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                ...
                <sup>Update FORM REQUEST PERMOHONAN</sup>
            </div>
            ...
            <div class="card-body">
                <form method="post" enctype="multipart/form-data" action="<?php echo e(route('add_request')); ?>">
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <input type="hidden" name="id_pengajuan" value="<?php echo e($dt->id_pengajuan); ?>">
                        <div class="row">
                            <div class="col-xl-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group position-relative has-icon-left">
                                    <input type="text" value="<?php echo e($dt->name); ?>" readonly=""
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group position-relative has-icon-left">
                                    <input type="text" value="<?php echo e($dt->tempat); ?>/<?php echo e($dt->tgl_lahir); ?>" readonly=""
                                        style="background: transparent;" class="form-control"
                                        placeholder="Lengkapi Biodata Anda" value="">
                                    <div class="form-control-icon">
                                        <i class="dripicons dripicons-information"></i>
                            ...
                            <div class="col-md-6">
                                <h6>Nim</h6>
                                <div class="form-group position-relative has-icon-left">
                                    <input type="text" value="<?php echo e($dt->nim); ?>" readonly=""
                                        style="background: transparent;" class="form-control"
                                        placeholder="Lengkapi Biodata Anda" value="">
                                    <div class="form-control-icon">
                                        <i class="dripicons dripicons-information"></i>
                            ...
                            <div class="col-md-6">
                                <h6>Program Studi</h6>
                                <div class="form-group position-relative has-icon-left">
                                    <input type="text" value="<?php echo e($dt->program->nama ?? ''); ?>" readonly=""
                                        style="background: transparent;" class="form-control"
                                        placeholder="Lengkapi Biodata Anda" value="">
                                    <div class="form-control-icon">
                                        <i class="dripicons dripicons-information"></i>
                            ...
                            <div class="col-md-6">
                                <h6>Tahun Ajaran</h6>
                                <div class="form-group position-relative has-icon-left">
                                    <input type="text" value="<?php echo e($dt->tahun_ajaran); ?>" readonly=""
                                        style="background: transparent;" class="form-control"
                                        placeholder="Lengkapi Biodata Anda" value="">
                                    <div class="form-control-icon">
                                        <i class="dripicons dripicons-information"></i>
                            ...
                            <div class="col-md-6">
                                <h6>Jenis Kelamin</h6>
                                <div class="form-group position-relative has-icon-left">
                                    <input type="text" value="<?php echo e($dt->jenis_kelamin); ?>" readonly=""
                                        style="background: transparent;" class="form-control"
                                        placeholder="Lengkapi Biodata Anda" value="">
                                    <div class="form-control-icon">
                                        <i class="dripicons dripicons-information"></i>
                            ...
                            <div class="col-xl-12">
                                <h6>Catatan Lain</h6>
                                <div class="form-group position-relative has-icon-left">
                                    <input type="text" required="" class="form-control" name="keperluan" value="<?php echo e($dt->keperluan); ?>"
                                        value="">
                                    <div class="form-control-icon">
...
<?php echo $__env->make('desa/layout/app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web-surat\resources\views/pengaju/data/update.blade.php ENDPATH**/ ?>