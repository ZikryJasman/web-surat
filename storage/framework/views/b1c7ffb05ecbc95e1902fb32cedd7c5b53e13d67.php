...
<form method="post" action="<?php echo e(route('ganti_password',$cst->id)); ?>">
    <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\xampp\htdocs\web-surat\resources\views/desa/profildesa/ganti.blade.php ENDPATH**/ ?>