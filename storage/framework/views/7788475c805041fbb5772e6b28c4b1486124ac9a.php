...
<div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
    ...
    <div class="modal-body">
        <form method="post" action="<?php echo e(route('tambah_prosedur')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-12">
...
</div><?php /**PATH C:\xampp\htdocs\web-surat\resources\views/desa/prosedur/tambah.blade.php ENDPATH**/ ?>