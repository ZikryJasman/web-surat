...
<head>
  ...
  <meta property="og:image" content="<?php echo e(asset('foto')); ?>/<?php echo e($dt->logo); ?>">
  <title>KANTOR DESA <?php echo e($dt->name_village); ?> KECAMATAN <?php echo e($dt->name_district); ?> <?php echo e($dt->name_city); ?></title>
  <meta content="" name="description">
  <meta content="" name="keywords">
  <link rel="shortcut icon" type="image/x-generic" href="<?php echo e(asset('foto')); ?>/<?php echo e($dt->logo); ?>">
  <!-- Favicons -->
  <!-- Google Fonts -->
...
<body>
  <div itemprop="image" itemscope="itemscope" itemtype="http://schema.org/ImageObject">
    <meta content="<?php echo e(asset('foto')); ?>/<?php echo e($dt->logo); ?>" itemprop="url"/> </div>

    <div id="preloader">
      <div class="loader">
        <center>
          <img src="<?php echo e(asset('foto')); ?>/<?php echo e($dt->logo); ?>" width="60">
        </center>
      </div>
    </div>
    <!-- ======= Header ======= -->
    <header id="header" class="d-flex align-items-center">
      <div class="container d-flex align-items-center">
        ...
        <h1 class="logo me-auto"><a href=""><img src="<?php echo e(asset('foto')); ?>/<?php echo e($dt->logo); ?>" width="auto" height="auto"></a></h1>
        <h1 class="logo me-auto text-center"><?php echo e($dt->name_village); ?></h1>
          ...
          <ul>
            ...
            <li class="dropdown"><a href="#"><span><?php echo e(Auth::user()->name); ?></span> <i class="bi bi-chevron-down"></i></a>
              <ul>
                ...
                <li><a href="<?php echo e(route('profil_desa',Auth::user()->title_user)); ?>" id="drop">Profil</a></li>
                <?php else: ?>
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">KANTOR DESA <?php echo e($dt->name_village); ?></h2>
                <p class="animate__animated animate__fadeInUp">Selamat datang di KANTOR DESA <?php echo e($dt->name_village); ?> KECAMATAN <?php echo e($dt->name_district); ?> <br><?php echo e($dt->name_city); ?></p>
                <a href="#services" class="btn-get-started animate__animated animate__fadeInUp scrollto">Ajukan Surat <i class="bx bx-file"></i></a>
              </div>
            </div>
          </div>
          ...
          <div class="row no-gutters">
            ...
            <div class="col-lg-4 col-md-6 text-center">
              <div class="icon-box">
                ...
                <p class="description">Jam Pelayanan <br> <?php echo e($lyn->waktu); ?> - <?php echo e($lyn->sampai); ?></p>
              </div>
            </div>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mt-2" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box iconbox-orange" style="border-left: 1px solid <?php echo e($srt->bg); ?>;border-bottom: 1px solid <?php echo e($srt->bg); ?>">
                <div class="icon">
                ...
                <p><?php echo e($srt->nama_surat); ?>
                  ...
                  <br>
                  <a href="" class="text text-black" data-bs-toggle="modal" data-bs-target="#detail<?php echo e($srt->id_surat); ?>"><u>Lihat Persyaratan</u></a>
                  <br>
                  <?php if(Auth::user()): ?>
                  <a href="<?php echo e(route('request',$srt->nama_surat)); ?>" class="btn btn-sm text-white mt-2" style="background: <?php echo e($srt->bg); ?>">Buat Surat</a>
                  <?php else: ?>
                  <a href="<?php echo e(route('login',$dt->title_user)); ?>" class="btn btn-sm text-white mt-2" style="background: <?php echo e($srt->bg); ?>">Buat Surat</a>
                  <?php endif; ?>
                </p>
              </div>
            </div>
            ...
            <div class="col-xl-12 pt-4 content">
              ...
              <ul>
                ...
                foreach($array as $item) {
                 echo " <li><i class='bi bi-check-circled'></i>"; echo $no.'. ' . $item; "</i></li>";
                 $no++;
               }
               ?>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="col-xl-12 d-flex align-items-stretch">
            <div class="info">
              ...
              <div class="address">
                ...
                <h4>Telepon:</h4>
                <p>
                  <?php echo e($dt->telepon_desa); ?>

                </p>
              </div>

              <iframe class="form-control"  height="290" style="width: 100%;" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=720&amp;height=600&amp;hl=en&amp;q=Kantor+Kelurahan+<?php echo e($dt->name_village); ?>+<?php echo e($dt->name_city); ?>+<?php echo e($dt->name_province); ?>+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
            </div>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="footer-top">
      <div class="container">
        <h3>KANTOR KANTOR DESA <?php echo e($dt->name_village); ?></h3>
        <div class="row gy-4">
          ...
          <div class="col-lg-4 footer-links">
            <h4>Kontak Kami</h4>
            Email : <?php echo e($dt->email); ?> <br>
            Telepon : <?php echo e($dt->telepon_desa); ?> 
          </div>

          <div class="col-lg-4 footer-contact text-center text-md-start">
            <h4>Alamat Kantor</h4>
            <p>
              <?php echo e($dt->lokasi_desa); ?>
