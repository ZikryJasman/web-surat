    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div class="avatar avatar-xl">
                    ...
                    <a href="<?php echo e(route('profil_desa',Auth::user()->title_user)); ?>"><img src="<?php echo e(asset('template/dist/assets/images/faces/1.jpg')); ?>" alt="Face 1"></a>
                    <?php else: ?>
                    <a href="<?php echo e(route('profil_desa',Auth::user()->title_user)); ?>"><img src="<?php echo e(asset('foto')); ?>/<?php echo e($dpf->logo); ?>" alt="Face 1"></a>
                    <?php endif; ?>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  has-sub <?php echo e(in_array(Route::currentRouteName(),['user_pengaju','user_pengurus'])?'active':''); ?>">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item <?php echo e(Route::currentRouteName()=='user_pengurus'?'active':''); ?>">
                ...
                <li class="sidebar-item  has-sub <?php echo e(Route::currentRouteName()=='waktu_layanan'?'active':''); ?>">
                    <a href="#" class='sidebar-link'>
                        <i class="dripicons dripicons-information"></i>
                        <span>Layanan</span>
                    </a>
                    <ul class="submenu ">
                        <li class="submenu-item <?php echo e(Route::currentRouteName()=='waktu_layanan'?'active':''); ?>">
                ...
                <li class="sidebar-item  has-sub <?php echo e(Route::currentRouteName()=='data_request'?'active':''); ?>">
                    <a href="#" class='sidebar-link'>
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item <?php echo e(Route::currentRouteName()=='data_request'?'active':''); ?>">
                ...
                <li class="sidebar-item  has-sub <?php echo e(Route::currentRouteName()=='staff_cetak'?'active':''); ?>">
                    <a href="#" class='sidebar-link'>
                    ...
                    <ul class="submenu ">
                        <?php $__currentLoopData = $request; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="submenu-item ">
                            <a href="<?php echo e(route('staff_cetak',$req->singkatan)); ?>"><?php echo e($req->singkatan); ?></a>
                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </li>
                ...
                <li class="sidebar-item <?php echo e(Route::currentRouteName()=='dashboard_kepaladesa'?'active':''); ?> ">
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        <?php $__currentLoopData = $request; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="submenu-item ">
                            <a href="<?php echo e(route('kepaladesa_acc',$req->singkatan)); ?>"><?php echo e($req->singkatan); ?></a>
                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </li>
