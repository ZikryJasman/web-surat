            ...
            <table class="table table-striped" id="table1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a href="{{route('staff_cek_berkas',['surat'=>$dt->singkatan,'id_pengajuan'=>$dt->id_pengajuan])}}" class="btn btn-sm btn-primary rounded-pill"><i class="icon dripicons-preview"></i></a>
                        </td>
                    </tr>
                    <?php $no++ ?>
                    @endforeach
