            ...
            <table class="table table-striped" id="table1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a href="{{route('ttd',['surat'=>$dt->singkatan,'id_pengajuan'=>$dt->id_pengajuan])}}?keyword=cek-surat" class="btn btn-sm btn-primary rounded-pill"><i class="icon dripicons-document-edit"></i></a>
                        </td>
                    </tr>
                    <?php $no++ ?>
                    @endforeach
