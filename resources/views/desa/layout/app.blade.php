...
<head>
    ...
    <title>@yield('title') | Web Surat Pengajuan</title>
    ...
    <script src="{{ asset('javascript-css/canva.js') }}"></script>
    <link href="{{ asset('javascript-css/foto.css') }}" rel="stylesheet">
...
<body>
    <div itemprop="image" itemscope="itemscope" itemtype="http://schema.org/ImageObject">
        <meta content="{{ asset('foto') }}/{{ $logodesa->logo }}" itemprop="url" />
    </div>
    <div id="app">
        @include('desa/layout/sidebar')
        <div id="main">
            <header class="mb-3">
    ...
    <script src="{{ asset('template/dist/alert.min.js') }}"></script>
    <!-- <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script> -->
