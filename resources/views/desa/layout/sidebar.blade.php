    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item  has-sub {{in_array(Route::currentRouteName(),['user_pengaju','user_pengurus'])?'active':''}}">
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item {{Route::currentRouteName()=='user_pengurus'?'active':''}}">
                ...
                <li class="sidebar-item  has-sub {{Route::currentRouteName()=='waktu_layanan'?'active':''}}">
                    <a href="#" class='sidebar-link'>
                        <i class="dripicons dripicons-information"></i>
                        <span>Layanan</span>
                    </a>
                    <ul class="submenu ">
                        <li class="submenu-item {{Route::currentRouteName()=='waktu_layanan'?'active':''}}">
                ...
                <li class="sidebar-item  has-sub {{Route::currentRouteName()=='data_request'?'active':''}}">
                    <a href="#" class='sidebar-link'>
                    ...
                    <ul class="submenu ">
                        ...
                        <li class="submenu-item {{Route::currentRouteName()=='data_request'?'active':''}}">
                ...
                <li class="sidebar-item {{Route::currentRouteName()=='dashboard_kepaladesa'?'active':''}} ">
