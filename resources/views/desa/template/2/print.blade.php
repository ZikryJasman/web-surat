    ...
    <div class="container-fluid" style="background: white;">
        <div class="row">
            <div class="col-xl-12">
                ...
                <ol style="margin-left: 15%;margin-top: 1%;">
                ...
                <center>
                    "Surat Keterangan ini digunakan untuk Keperluan <b><i><u>{{$dt->keperluan}}</u></i></b>"<br>
                Demikian surat ini diberikan kepada yang bersangkutan agar dapat dipergunakan untuk sebagaimana mestinya.</p>
