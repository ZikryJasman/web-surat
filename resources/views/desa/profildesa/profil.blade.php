                             ...
                             <tbody>
                                 @foreach ($data as $cst)
                                     ...
                                     <tr>
                                         ...
                                         <td>:</td>
                                         <td>
                                             <img src="{{ 'https://indonesiasehat.org/web-surat/public/' . $cst->logo }}"
                                                 width="70">
                                         </td>
                                     </tr>
             ...
             @foreach ($data as $cst)
                 ...
                 @else
                     <div class="col-12"><iframe class="form-control" height="400" frameborder="0" scrolling="no"
                             ...
                             src="https://maps.google.com/maps?width=720&amp;height=600&amp;hl=en&amp;q=Kantor+Kelurahan+{{ $cst->name_village }}+{{ $cst->name_district }}+{{ $cst->name_city }}+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
                     </div>
                 @endif
             @endforeach
         </div>
