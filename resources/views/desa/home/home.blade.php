...
<head>
    ...
    <meta property="og:image" content="{{ asset('foto/bootstrap.png') }}">
    <title>Aplikasi Kemahasiswaan</title>
    <meta content="" name="description">
    <meta content="" name="keywords">
    <link rel="shortcut icon" type="image/x-generic" href="{{ asset('foto/bootstrap.png') }}">
    <!-- Favicons -->
    <!-- Google Fonts -->
    <link
...
<body>
    <div itemprop="image" itemscope="itemscope" itemtype="http://schema.org/ImageObject">
        <meta content="{{ asset('foto/bootstrap.png') }}" itemprop="url" />
    </div>

    <div id="preloader">
        <div class="loader">
            <center>
                <img src="{{ asset('foto/bootstrap.png') }}" width="60">
            </center>
        </div>
    </div>
    <!-- ======= Header ======= -->
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href=""><img src="{{ asset('foto/bootstrap.png') }}" width="auto"
                        height="auto"></a></h1>
                        ...
                        <li class="dropdown"><a href="#"><span>{{ Auth::user()->name }}</span> <i
                            ...
                            <ul>
                                @if (Auth::user()->level == 'Desa')
                                    <li><a href="{{ route('profil_desa', Auth::user()->title_user) }}"
                                            id="drop">Profil</a></li>
                                @else
                    ...
                    @foreach ($layanan as $lyn)
                        <div class="col-lg-4 col-md-6 text-center">
                            <div class="icon-box">
                                ...
                                <p class="description">Jam Pelayanan <br> {{ $lyn->waktu }} - {{ $lyn->sampai }}
                                </p>
                            </div>
                        </div>
                    @endforeach
                    ...
                    @foreach ($surat as $srt)
                        <div class="col-lg-4 col-md-6 mt-2" data-aos="zoom-in" data-aos-delay="100">
                            <div class="icon-box iconbox-orange"
                                style="border-left: 1px solid {{ $srt->bg }};border-bottom: 1px solid {{ $srt->bg }}">
                                <div class="icon">
                                ...
                                <p>{{ $srt->nama_surat }}
                                    ...
                                    <a href="" class="text text-black" data-bs-toggle="modal"
                                        data-bs-target="#detail{{ $srt->id_surat }}"><u>Lihat Persyaratan</u></a>
                                    <br>
                                    @if (Auth::user())
                                        <a href="{{ route('request', $srt->nama_surat) }}"
                                            class="btn btn-sm text-white mt-2"
                                            style="background: {{ $srt->bg }}">Buat Surat</a>
                                    @else
                                        <a href="{{ route('login', $dt->title_user) }}"
                                            class="btn btn-sm text-white mt-2"
                                            style="background: {{ $srt->bg }}">Buat Surat</a>
                                    @endif
                                </p>
                    ...
                    <div class="col-xl-12 d-flex align-items-stretch">
                        <div class="info">
                            ...
                            <iframe class="form-control" height="290" style="width: 100%;" frameborder="0"
                                ...
                                src="https://maps.google.com/maps?width=720&amp;height=600&amp;hl=en&amp;q=Kantor+Kelurahan+{{ $dt->name_village }}+{{ $dt->name_city }}+{{ $dt->name_province }}+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
                        </div>
