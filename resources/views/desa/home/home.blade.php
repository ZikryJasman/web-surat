...
<head>
  ...
  <title>KANTOR DESA {{$dt->name_village}} KECAMATAN {{$dt->name_district}} {{$dt->name_city}}</title>
...
<body>
  <div itemprop="image" itemscope="itemscope" itemtype="http://schema.org/ImageObject">
    ...
    <header id="header" class="d-flex align-items-center">
      <div class="container d-flex align-items-center">
        ...
        <h1 class="logo me-auto"><a href=""><img src="{{asset('foto')}}/{{$dt->logo}}" width="auto" height="auto"></a></h1>
        <h1 class="logo me-auto text-center">{{$dt->name_village}}</h1>
          ...
          <ul>
            ...
            <li class="dropdown"><a href="#"><span>{{Auth::user()->name}}</span> <i class="bi bi-chevron-down"></i></a>
              <ul>
                ...
                <li><a href="{{route('profil_desa',Auth::user()->title_user)}}" id="drop">Profil</a></li>
                @else
            ...
            @else
            <li><a class="getstarted scrollto" href="{{route('login',$dt->title_user)}}">LOGIN</a></li>
            @endif
          </ul>
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">KANTOR DESA {{$dt->name_village}}</h2>
                <p class="animate__animated animate__fadeInUp">Selamat datang di KANTOR DESA {{$dt->name_village}} KECAMATAN {{$dt->name_district}} <br>{{$dt->name_city}}</p>
          ...
          <div class="row no-gutters">
            ...
            <div class="col-lg-4 col-md-6 text-center">
              <div class="icon-box">
                ...
                <h4 class="title">{{$lyn->hari}}</h4>
                <p class="description">Jam Pelayanan <br> {{$lyn->waktu}} - {{$lyn->sampai}}</p>
              </div>
            </div>
            @endforeach
          </div>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 mt-2" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box iconbox-orange" style="border-left: 1px solid {{$srt->bg}};border-bottom: 1px solid {{$srt->bg}}">
                <div class="icon">
                ...
                <h4><a href="">{{$srt->singkatan}}</a></h4>
                <p>{{$srt->nama_surat}}
                  <br>
                  <a href="" class="text text-black" data-bs-toggle="modal" data-bs-target="#detail{{$srt->id_surat}}"><u>Lihat Persyaratan</u></a>
                  <br>
                  @if(Auth::user())
                  <a href="{{route('request',$srt->nama_surat)}}" class="btn btn-sm text-white mt-2" style="background: {{$srt->bg}}">Buat Surat</a>
                  @else
                  <a href="{{route('login',$dt->title_user)}}" class="btn btn-sm text-white mt-2" style="background: {{$srt->bg}}">Buat Surat</a>
                  @endif
                </p>
              </div>
            </div>
            @include('desa/home/persyaratan')
            @endforeach
        ...
        <div class="row">
          ...
          <div class="col-xl-12 d-flex align-items-stretch">
            <div class="info">
              ...
              <iframe class="form-control"  height="290" style="width: 100%;" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=720&amp;height=600&amp;hl=en&amp;q=Kantor+Kelurahan+{{$dt->name_village}}+{{$dt->name_city}}+{{$dt->name_province}}+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
            </div>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="footer-top">
      <div class="container">
        <h3>KANTOR KANTOR DESA {{$dt->name_village}}</h3>
        <div class="row gy-4">
  ...
  <script src="{{asset('green/jquery.min.js')}}"></script>
