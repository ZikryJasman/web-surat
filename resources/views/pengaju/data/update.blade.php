...
@section('title', 'Update Surat Permohonan')
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" enctype="multipart/form-data" action="{{ route('add_request') }}">
                    @csrf
                    @foreach ($data as $dt)
                        <input type="hidden" name="id_pengajuan" value="{{ $dt->id_pengajuan }}">
                        <div class="row">
                            <div class="col-xl-12">
                            ...
                            <div class="col-xl-12">
                                <h6>Catatan Lain</h6>
                                <div class="form-group position-relative has-icon-left">
                                    <input type="text" required="" class="form-control" name="keperluan" value="{{$dt->keperluan}}"
                                        value="">
                                    <div class="form-control-icon">
